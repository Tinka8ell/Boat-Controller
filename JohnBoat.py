# !/usr/bin/python3
# JohnBoat - Implementation of remote control boat with Blue Dot for John
...
if __name__ == '__main__':
   ...
   * hardware PWM is on pins:
   ...
   # other pins
   servo = 13 
   switchPin = 16 # used for pi on indiacator

   # Turret controls
   expandor2 = 0 # should be 1 if 2 expandors ...
   g1a = Turret(8, (expandor2, 0, 0))   # smaller rear facing port turret - 2nd expander, PortA, ls Nible (from 0 to 8)
   g1b = Turret(8, (expandor2, 1, 0))   # smaller rear facing starboard turret - 2nd expander, PortB, ls Nible (from 0 to 8)
   g2 = Turret(8, (0, 0, 0))    # port pair - PortA, ls Nible (from 0 to 8)
   g3 = Turret(8, (0, 1, 0))    # starboard pair - PortB, ls Nible (from 0 to 8)
   guns = (g1a, g1b, g2, g3)
   ...
   boat = GPIOZeroBoat(left, right, center, servo, gun=guns) # boat with added turrets
